...
def header():
    ...
    options1 = r"""
[!] - Bem-vindo ao módulo 5: Calculo da velocidade em função de ΔU.
"""
...
while chave > counter:
    try:
        ...
        ve_x_va_ener_int = math.sqrt(((5*v*n)*(p1-p2)/m))
...
\033[38;5;208mO resultado obtido para Velocidade >>> {ve_x_va_ener_int:.2f} metros por segundo.\033[0m''')
