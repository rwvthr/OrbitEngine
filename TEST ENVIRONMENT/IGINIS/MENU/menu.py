...
print('Olá, seja bem-vindo ao menu do IGNIS! Iniciando...')

time.sleep(1.5)
system('cls')

tempo = float(input('Digite o tempo, em segundos, necessário para ler os dados do projeto: Ex: 5 (apenas números): '))
...
------------------------------------------------------------------------------------
Título do projeto: ModeModelagem Matemática e Simulação Computacional
...
print('Deseja ler alguns avisos importantes antes de prosseguir? (s/n): ')
per = input().lower()
...
print('Antes de acessar o menu principal, vamos explicar como o programa funciona: ')
print('''
...
#FALTA IMPLEMENTAR AS FUNÇÕES DE CÁLCULO E GRÁFICOS, ESSA É APENAS A ESTRUTURA DO MENU PRINCIPAL.
