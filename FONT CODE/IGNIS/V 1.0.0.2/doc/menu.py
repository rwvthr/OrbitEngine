...
while chave > chaveanterior[index]:
    ...
    Confira o catálogo e os números correspondente ao serviço desejado:
            ...
            * Cálculo:
            ...
            6 - Calcular a velocidade (para o cálculo do rendimento).
            7 - Calcular o rendimento (η).
            
                
            * Geração de Gráficos:
                
            8 - Gerar o gráfico do Alcance em função da Pressão Final (P2).
            9 - Gerar o gráfico do Alcance em função do Rendimento (η).
            10 - Gerar o gráfico de V0x (velocidade horizontal) vs Tempo.
            11 - Gerar o gráfico de V0y (velocidade vertical) vs Tempo.
            0 - Sair do programa.
